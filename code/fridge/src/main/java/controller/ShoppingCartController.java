...
public class ShoppingCartController {
	...
	public Set<ShoppingListItem> createShoopingCart() throws ParseException {
		 ...
		 * shoppingListProducts.add(new ShoppingListItem("i1", 1.99d,
		 * "Belegte Banane", 1, 1, 2, true)); shoppingListProducts.add(new
		 * ShoppingListItem("i2", 2.99d, "Abenteurlicher Apfel", 1, 5, 10,
		 * true)); shoppingListProducts.add(new ShoppingListItem("i3", 458.99d,
