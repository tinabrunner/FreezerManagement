...
public class DB_ProductList {
	...
	public List<Product> getAllProducts() {
		...
		/*
		 * products.find().forEach((Block<Document>) doc -> { String id =
		 * doc.getString("id"); String name = doc.getString("name"); int
		 * verpackungsgroesse = doc.getInteger("verpackungsgroesse"); double
		 * price = doc.getDouble("price"); allProducts.add(new Product(id, name,
		 * verpackungsgroesse, price)); });
		 */
